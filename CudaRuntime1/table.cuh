...
#define U8_C(x) static_cast<std::uint8_t>(x)

struct Table {
	kuznechikByteVector table[16][256];
};

//__device__ constexpr kuznechikByteVector TABLE[16][256] = { { &{ U8_C(0xfc), U8_C(0xb5), U8_C(0xae), U8_C(0xc9), U8_C(0x1b), U8_C(0x93), U8_C(0x87), U8_C(0x11), U8_C(0x19), U8_C(0x96), U8_C(0x80), U8_C(0xc0), U8_C(0x7a), U8_C(0x0c), U8_C(0xd5), U8_C(0xfb) },
...
__device__ constexpr uint8_t tt[16][256][16] = {{{0xfc, 0xb5, 0xae, 0xc9, 0x1b, 0x93, 0x87, 0x11, 0x19, 0x96, 0x80, 0xc0, 0x7a, 0x0c, 0xd5, 0xfb},
{ 0xee, 0x0a, 0xf2, 0xfe, 0xf8, 0xab, 0xfc, 0x32, 0x7b, 0xce, 0x1a, 0x17, 0xb2, 0x8c, 0xe0, 0x08 },
{ 0xdd, 0x89, 0xc7, 0x88, 0x4e, 0xef, 0xca, 0xbd, 0xc0, 0x77, 0xdc, 0xb2, 0x50, 0xa2, 0xd0, 0xcb },
{ 0x11, 0xc0, 0x13, 0x93, 0xd3, 0x3c, 0x12, 0xc4, 0x69, 0xd6, 0x42, 0x63, 0x5e, 0x1a, 0x10, 0x41 },
{ 0xcf, 0x36, 0x9b, 0xbf, 0xad, 0xd7, 0xb1, 0x9e, 0xa2, 0x2f, 0x46, 0x65, 0x98, 0x22, 0xe5, 0x38 },
