...
public:
	...
	double testStreams(std::vector<magmaBlockT>& data, const size_t blockSize, const size_t gridSize, const size_t numStreams, const size_t tileSize, const bool encryptStatus);
